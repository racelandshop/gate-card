...
customElements.define('action-handler-gate-card', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-gate-card')) {
    return body.querySelector('action-handler-gate-card') as ActionHandler;
  }
  const actionhandler = document.createElement('action-handler-gate-card');
